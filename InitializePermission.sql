...
INSERT INTO [dbo].[Functions]([Id],[Name],[Url],[ParentId],[SortOrder],[CssClass],[IsActive]) VALUES('ADMIN',N'Nhóm người dùng','/admin/system/role','SYSTEM',1,'icon-role',1)
INSERT INTO [dbo].[Functions]([Id],[Name],[Url],[ParentId],[SortOrder],[CssClass],[IsActive]) VALUES('USER',N'Người dùng','/admin/system/user','SYSTEM',2,'icon-user',1)
INSERT INTO [dbo].[Functions]([Id],[Name],[Url],[ParentId],[SortOrder],[CssClass],[IsActive]) VALUES('SETTING',N'Cấu hình','/admin/system/setting','SYSTEM',3,'icon-setting',1)
...
INSERT INTO [dbo].[ActionInFunctions]([FunctionId],[ActionId])VALUES('USER','CREATE')
INSERT INTO [dbo].[ActionInFunctions]([FunctionId],[ActionId])VALUES('USER','UPDATE')
INSERT INTO [dbo].[ActionInFunctions]([FunctionId],[ActionId])VALUES('USER','DELETE')
INSERT INTO [dbo].[ActionInFunctions]([FunctionId],[ActionId])VALUES('USER','VIEW')
INSERT INTO [dbo].[ActionInFunctions]([FunctionId],[ActionId])VALUES('USER','IMPORT')